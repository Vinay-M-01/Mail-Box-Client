...
const CreateEmail = () => {
  ...
  const sendMailHandler = () => {
    ...
    fetch(`https://mailbox-client-f1eeb-default-rtdb.firebaseio.com/${cleanToEmail}/inbox.json`,{
      method: 'POST',
      headers: {
    ...
    fetch(`https://mailbox-client-f1eeb-default-rtdb.firebaseio.com/${cleanUserEmail}/sentemails.json`, {
      method: "POST",
      headers: {
        "Content-type": "application-json",
      },
